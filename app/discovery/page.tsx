...
import { Search, Globe, Network, Cpu, Lock } from "lucide-react";
...
export default function DiscoveryPage() {
  ...
  return (
    <div className="w-full max-w-[90rem] mx-auto flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-8 duration-700 pb-20">
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="font-semibold text-card-foreground/70 mt-1">
              Topological relationship map of all external network vectors.
            </p>
          </div>
        </div>
      ...
      <div className="bg-card-background/60 backdrop-blur-3xl border border-white/20 shadow-xl rounded-[2rem] overflow-hidden h-[600px] relative">
        ...
        {data.nodes.map((node: any) => (
          <div 
            key={node.id}
            className={`absolute flex flex-col items-center justify-center -translate-x-1/2 -translate-y-1/2 transition-transform hover:scale-110 cursor-pointer group hover:z-50`}
